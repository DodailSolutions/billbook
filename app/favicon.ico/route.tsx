...
export async function GET(request: NextRequest) {
  ...
  return new ImageResponse(
    (
      ...
      >
        <svg width="22" height="22" viewBox="0 0 340 340">
          ...
          <path d="M 175 210 L 205 240 L 255 170" 
                stroke="#005DEE" strokeWidth="32" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
          <path d="M 270 245 L 270 285 L 230 285 Z" fill="#38B6FF"/>
        </svg>
      </div>
    ),
    {
