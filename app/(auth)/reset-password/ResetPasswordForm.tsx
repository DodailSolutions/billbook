    ...
    return (
        <Card className="max-w-md mx-auto">
            ...
            <CardContent>
                ...
                {clientError && (
                    <div className="mb-4 p-3 rounded-lg text-sm bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-800 dark:text-red-200 flex gap-2">
                        <AlertCircle className="h-4 w-4 shrink-0 mt-0.5" />
                ...
                <form 
                    action={async (formData) => {
                        ...
                        setClientError('')
                        // Call server action without await
