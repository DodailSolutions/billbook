...
export const metadata: Metadata = {
  title: 'Features - Free Invoice Generator with GST Compliance | BillBooky',
  description: 'Explore BillBooky features: GST-compliant invoicing, recurring billing, customer management, payment tracking, custom branding, and more. 100% free invoice software for Indian businesses.',
  keywords: [
