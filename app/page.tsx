...
const ALL_FEATURES = [
    { icon: FileText, title: 'GST Compliant Invoicing', desc: 'Create CGST, SGST, IGST invoices with QR code payment in 30 seconds', color: 'blue' },
    { icon: Sparkles, title: 'CRM & Sales Pipeline', desc: 'Visual deal stages, activity timeline follow-ups, and win rate forecasts', color: 'indigo' },
    ...
    { icon: ShoppingBag, title: 'Purchase Orders', desc: 'Issue vendor POs, track partial deliveries, and auto-update stock inventory', color: 'amber' },
    { icon: DollarSign, title: 'Payroll & Salary Slips', desc: 'Employee salary structures, PF/ESI/TDS deductions, and PDF payslips', color: 'rose' },
    { icon: Layers, title: 'Inventory Valuation', desc: 'Weighted average stock valuation, batch/lot tracking, and reorder alerts', color: 'purple' },
    { icon: Bot, title: 'AI Accountant Assistant', desc: 'Ask natural language tax & finance questions powered by AI logic', color: 'cyan' },
    { icon: Users, title: 'CA Marketplace & Audit', desc: 'Connect with certified CAs for tax filing, audit reports, and advice', color: 'teal' },
    { icon: RefreshCw, title: 'Recurring Subscriptions', desc: 'Automate monthly and annual invoice generation with auto reminders', color: 'orange' },
    { icon: Smartphone, title: 'WhatsApp Direct Share', desc: 'Send PDF invoice links directly to client WhatsApp numbers in 1 click', color: 'emerald' },
    ...
    { icon: Lock, title: 'Bank Grade Security', desc: '256-bit encryption, automated daily backups, and complete data privacy', color: 'indigo' },
]
