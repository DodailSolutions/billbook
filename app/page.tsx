...
const ALL_FEATURES = [
    { icon: FileText, title: 'GST Compliant Invoicing', desc: 'Create CGST, SGST, IGST invoices with QR code payment in under 30 seconds', color: 'blue' },
    ...
    { icon: BookOpen, title: 'Double-Entry Bookkeeping', desc: 'Chart of Accounts, Trial Balance, P&L, Balance Sheet & Bank Reconciliation', color: 'blue' },
    ...
    { icon: DollarSign, title: 'Payroll & Salary Slips', desc: 'Employee salary structures, PF/ESI/TDS deductions, and PDF payslips', color: 'blue' },
    ...
    { icon: Bot, title: 'AI Accountant Assistant', desc: 'Ask natural language tax & finance questions powered by AI logic', color: 'blue' },
    ...
    { icon: RefreshCw, title: 'Recurring Subscriptions', desc: 'Automate monthly and annual invoice generation with auto reminders', color: 'blue' },
    ...
    { icon: ShieldCheck, title: 'Multi-User Team Roles', desc: 'Assign Owner, Admin, Manager, and Accountant access permissions', color: 'blue' },
...
export default function Home() {
    return (
        <div className="min-h-screen bg-white text-slate-950 selection:bg-blue-600 selection:text-white font-sans antialiased">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16 sm:h-20">
                        ...
                        <div className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-600">
                            ...
                            <Link href="/ca-registration" className="hover:text-blue-600 font-bold transition-colors">Register as CA</Link>
            ...
            <section className="relative pt-12 sm:pt-20 pb-20 md:pb-28 overflow-hidden bg-white">
                ...
                <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] sm:w-[800px] h-[400px] bg-gradient-to-tr from-blue-500/10 via-blue-400/5 to-slate-200/20 blur-[120px] rounded-full pointer-events-none" />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-4xl mx-auto space-y-6 sm:space-y-8">
                        ...
                        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black text-slate-950 -tracking-tight leading-[1.08]">
                            ...
                            <span className="bg-gradient-to-r from-slate-950 via-blue-600 to-blue-500 bg-clip-text text-transparent">
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-6 pt-4 text-xs text-slate-600 font-semibold">
                            ...
                            <div className="flex items-center gap-1.5 text-slate-700">
                                <CheckCircle className="w-4 h-4 text-blue-600" /> 100% GST Compliant
                            </div>
                            <span className="hidden sm:inline text-slate-300">•</span>
                            <div className="flex items-center gap-1.5 text-slate-700">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                        ...
                        <div className="p-4 rounded-2xl bg-white border border-slate-200/80 shadow-xs">
                            <div className="text-3xl sm:text-4xl font-black text-blue-600 font-mono">₹10Cr+</div>
                        ...
                        <div className="p-4 rounded-2xl bg-white border border-slate-200/80 shadow-xs">
                            <div className="text-3xl sm:text-4xl font-black text-blue-600 font-mono">6-in-1</div>
            ...
            <section id="showcase" className="py-20 sm:py-28 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
                    <div className="text-center max-w-3xl mx-auto space-y-4">
                        <span className="inline-block px-4 py-1.5 rounded-full bg-blue-50 text-blue-700 text-xs font-bold uppercase tracking-wider border border-blue-200/80">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {ALL_FEATURES.map((feature, idx) => {
                            ...
                            return (
                                <div 
                                    key={idx}
                                    className="bg-white p-7 rounded-[24px] border border-slate-200/80 hover:border-blue-500/40 hover:shadow-2xl shadow-slate-100 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-1 group"
                                >
            ...
            <section id="pricing" className="py-20 sm:py-28 bg-white border-t border-slate-200/60">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
                    <div className="text-center max-w-3xl mx-auto space-y-4">
                        <span className="inline-block px-4 py-1.5 rounded-full bg-blue-50 text-blue-800 text-xs font-bold uppercase tracking-wider border border-blue-200">
                            Transparent Pricing
                        </span>
                        <h2 className="text-3xl sm:text-5xl font-black text-slate-950 -tracking-tight">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        ...
                        <div className="bg-white p-8 rounded-[28px] border border-slate-200/80 space-y-6 flex flex-col justify-between hover:shadow-xl transition-all shadow-xs">
                            <div className="space-y-4">
                                ...
                                <ul className="space-y-3 pt-4 border-t border-slate-100 text-xs text-slate-700 font-semibold">
                                    <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-blue-600 shrink-0" /> 50 Invoices / Month</li>
                                    <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-blue-600 shrink-0" /> GST Tax Compliance</li>
                                    <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-blue-600 shrink-0" /> Customer & Items Directory</li>
                                    <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-blue-600 shrink-0" /> Basic Financial Reports</li>
                                </ul>
                            </div>
                            <Link href="/signup">
                        ...
                        {/* Pro Starter Plan */}
                        <div className="bg-white p-8 rounded-[28px] border-2 border-blue-600 space-y-6 flex flex-col justify-between shadow-2xl relative">
                            ...
                            <div className="space-y-4">
                                <span className="text-sm font-bold text-blue-700 uppercase tracking-wider block">Pro Starter</span>
                                <div>
                            ...
                            <Link href="/signup">
                                <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-extrabold min-h-[44px] rounded-full shadow-lg shadow-blue-600/25">
            ...
            <section className="py-20 bg-black text-white shadow-2xl relative overflow-hidden">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6 relative z-10">
                    ...
                    <Link href="/signup" className="inline-block">
                        <Button size="lg" className="bg-blue-600 text-white hover:bg-blue-700 font-black px-8 py-4 rounded-full shadow-xl text-base min-h-[52px] gap-2 hover:scale-105 transition-all duration-300">
