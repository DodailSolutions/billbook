...
import { FileText, Users, IndianRupee, Zap, CheckCircle, Shield, TrendingUp, RefreshCw, Clock, Building2, UserCheck, Briefcase, Award } from 'lucide-react'
...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link href="/ca-registration">
                  <Button variant="outline" className="hidden md:inline-flex border-2 border-blue-600 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20">
                ...
                <div className="mt-6 p-4 rounded-xl bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-100 dark:border-blue-800">
                  <div className="flex items-center justify-between flex-wrap gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900 dark:text-white">Are you a Chartered Accountant?</p>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Join our CA marketplace and connect with businesses</p>
                      </div>
                    </div>
                    <Link href="/ca-registration">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <div className="inline-block">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20 mb-4">
                ...
                <span className="text-sm font-medium text-blue-600">CA Marketplace</span>
              </div>
            </div>
            <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-gray-900 dark:text-white">
              Need Expert CA Services?
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Connect with verified Chartered Accountants for GST filing, tax returns, audits, and more
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {/* For Businesses */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-lg transition-all">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    Find the perfect CA for your business needs
                  </p>
                </div>
              </div>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">Browse verified CA profiles</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="h-5 w-5 text-emerald-600 shrink-0" />
                  <span className="text-gray-700 dark:text-gray-300">Compare rates and specializations</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="h-5 w-5 text-emerald-600 shrink-0" />
                  <span className="text-gray-700 dark:text-gray-300">Read reviews from other businesses</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="h-5 w-5 text-emerald-600 shrink-0" />
                  <span className="text-gray-700 dark:text-gray-300">Get proposals within 24-48 hours</span>
                </li>
              </ul>

              <div className="flex gap-3">
                <Link href="/reports/ca-marketplace" className="flex-1">
                  <Button className="w-full bg-emerald-600 hover:bg-emerald-700">
                    Browse CAs
                  </Button>
                </Link>
                <Link href="/reports/hire-ca" className="flex-1">
            ...
            <div className="bg-linear-to-br from-blue-600 to-indigo-600 rounded-2xl p-8 text-white shadow-lg hover:shadow-xl transition-all">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-blue-100">
                    Grow your practice by connecting with clients
                  </p>
                </div>
              </div>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-blue-50">Create your professional profile</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="h-5 w-5 text-white shrink-0" />
                  <span className="text-blue-50">Showcase your expertise and credentials</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="h-5 w-5 text-white shrink-0" />
                  <span className="text-blue-50">Receive client requests directly</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="h-5 w-5 text-white shrink-0" />
                  <span className="text-blue-50">Build your reputation with reviews</span>
                </li>
              </ul>

              <div className="flex gap-3">
                <Link href="/ca-registration" className="flex-1">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600 mb-1">ICAI</div>
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">24-48h Response</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-600 mb-1">Secure</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Safe Payments</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-600 mb-1">Rated</div>
      ...
      {/* Pricing Section */}
      <section id="pricing" className="px-6 py-16 md:py-24 bg-gray-50 dark:bg-gray-900/50">
        <div className="max-w-7xl mx-auto">
