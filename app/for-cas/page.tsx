                ...
                <>
                  ...
                  <Link href="/login">
                    <Button 
                      size="lg" 
                      variant="outline"
                      className="border-2 border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800"
                    >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {STATS.map((stat) => {
              ...
              return (
                <div key={stat.label} className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200 text-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {BENEFITS.map((benefit) => {
            ...
            return (
              <div 
                key={benefit.title}
                className="group bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-lg hover:border-blue-200 dark:hover:border-blue-700 transition-all duration-200"
              >
      ...
      <section className="px-6 py-20 md:py-32 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {SERVICES_YOU_CAN_OFFER.map((service) => (
            <div 
              key={service}
              className="flex items-center gap-3 bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md hover:border-blue-200 dark:hover:border-blue-700 transition-all duration-200"
            >
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h4 className="text-xl font-bold text-gray-900 dark:text-white">BillBooky</h4>
              </div>
            ...
            <div>
              <h5 className="font-bold text-gray-900 dark:text-white mb-4">For CAs</h5>
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                <li><Link href="/ca-registration" className="hover:text-blue-600 transition-colors">Register as CA</Link></li>
                <li><Link href="/login" className="hover:text-blue-600 transition-colors">CA Login</Link></li>
                <li><Link href="/for-cas" className="hover:text-blue-600 transition-colors">Why Join Us</Link></li>
              </ul>
            </div>
