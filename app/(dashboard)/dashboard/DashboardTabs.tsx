            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-gray-100 ">
                <div className="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p className="text-sm md:text-base text-gray-600 text-gray-600 mt-1 md:mt-2">
                    ...
                    <button
                        ...
                        className={`pb-3 px-1 font-medium text-sm transition-colors relative ${
                            activeTab === 'dashboard'
                                ...
                                : 'text-gray-600 text-gray-600 hover:text-gray-900 dark:hover:text-gray-200'
                        }`}
                    >
                        Dashboard
                        {activeTab === 'dashboard' && (
                ...
                <div className="grid gap-3 sm:gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                    <Card className="border-l-4 border-l-green-500 hover:shadow-lg hover:-translate-y-1 transition-all duration-200 bg-white dark:bg-slate-800">
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            <div className="h-10 w-10 rounded-full bg-linear-to-br from-green-100 to-emerald-100  flex items-center justify-center shadow-sm">
                                <DollarSign className="h-5 w-5 text-green-600 text-green-600" />
                            </div>
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl md:text-3xl font-bold text-green-600 text-green-600">
                    ...
                    <Card className="border-l-4 border-l-blue-500 hover:shadow-lg hover:-translate-y-1 transition-all duration-200 bg-white dark:bg-slate-800">
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            <div className="h-10 w-10 rounded-full bg-linear-to-br from-blue-100 to-indigo-100  flex items-center justify-center shadow-sm">
                                <FileText className="h-5 w-5 text-blue-600 text-blue-600" />
                            </div>
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl md:text-3xl font-bold text-blue-600 text-blue-600">
                                {stats.totalInvoices}
                            </div>
                            <p className="text-xs text-gray-500 text-gray-600 mt-1">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-start gap-4 p-4 bg-gray-50/50 rounded-lg">
                                <div className="w-10 h-10 rounded-full bg-blue-100  flex items-center justify-center shrink-0">
                                    <FileText className="w-5 h-5 text-blue-600 text-blue-600" />
                                </div>
                                <div className="flex-1">
                                    <p className="font-medium text-gray-900 dark:text-white">New invoice created</p>
                                    <p className="text-sm text-gray-600 text-gray-600">Invoice #INV-001 for ₹10,000</p>
                            ...
                            <div className="flex items-start gap-4 p-4 bg-gray-50/50 rounded-lg">
                                <div className="w-10 h-10 rounded-full bg-green-100  flex items-center justify-center shrink-0">
                                    <CheckCircle className="w-5 h-5 text-green-600 text-green-600" />
                                </div>
                                <div className="flex-1">
                                    <p className="font-medium text-gray-900 dark:text-white">Payment received</p>
                                    <p className="text-sm text-gray-600 text-gray-600">₹5,000 received for Invoice #INV-002</p>
