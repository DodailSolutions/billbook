            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-3 text-sm">
                  ...
                  <ul className="mt-2 space-y-1 text-gray-600 ml-4 list-disc">
          ...
          <div className="grid gap-4 md:grid-cols-4">
            <Link href="/invoices" className="block">
              <div className="bg-white p-4 rounded-lg border border-gray-200 hover:shadow-lg transition-all hover:-translate-y-1 cursor-pointer">
                ...
                <p className="text-sm text-gray-600">View invoices and share via WhatsApp</p>
              </div>
            </Link>
            <Link href="/customers" className="block">
              <div className="bg-white p-4 rounded-lg border border-gray-200 hover:shadow-lg transition-all hover:-translate-y-1 cursor-pointer">
                ...
                <p className="text-sm text-gray-600">Add phone numbers to contacts</p>
              </div>
            </Link>
            <button 
              onClick={() => {
            ...
            >
              <div className="bg-white p-4 rounded-lg border border-green-200 dark:border-green-700 hover:shadow-lg transition-all hover:-translate-y-1 cursor-pointer">
                ...
                <p className="text-sm text-gray-600">Verify integration is working</p>
              </div>
            </button>
