...
interface DownloadPOPDFButtonProps {
    poId: string
    poNumber: string
}

export function DownloadPOPDFButton({ poId, poNumber }: DownloadPOPDFButtonProps) {
    ...
    const handleDownload = async () => {
        ...
        try {
            // Fetch the PO HTML
            const response = await fetch(`/api/purchase-orders/${poId}/pdf?mode=html`)
            
            if (!response.ok) {
                throw new Error('Failed to fetch purchase order layout')
            }
